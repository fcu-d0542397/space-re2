...
def run():
    ...
    for i in range(8,10):
        for j in range(0,len(speed)):
            ...
            saveName1 =  "./data/"+str(currentTime) + "-Ospeed-" + str(speed[j]) + "-space-"+str(i)+"-fleetSpeed.txt"
            saveName2 =  "./data/"+str(currentTime) + "-Ospeed-" + str(speed[j]) + "-space-"+str(i)+"-noFleetSpeed.txt"
            saveName3 =  "./data/"+str(currentTime) + "-Ospeed-" + str(speed[j]) + "-space-"+str(i)+"-group.txt"
            # print("\n"+currentTime)
